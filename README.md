...
README 之前已经提到“日记集成”，但没有写清楚怎么用。当前插件支持把今天的任务同步到当日日记中，常见用法如下：
...
README 之前已经提到“拖拽到 Markdown”，但也缺少具体说明。当前支持直接把侧边栏任务拖进 Obsidian 编辑器：
...
README 之前只提到了支持 OAuth 一键认证，但没有给出失败排查。若认证失败，优先检查下面几项：
