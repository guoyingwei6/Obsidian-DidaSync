...
var McpServerManager = class {
  ...
  taskMutationProperties(includeRequestId) {
    ...
    if (includeRequestId)
      properties.requestId = { type: "string", description: "Optional idempotency key for create calls. Reuse the same value only when retrying the same create request." };
    return properties;
  }
